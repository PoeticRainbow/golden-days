...
void main() {
    ...
    vec4 light_color = texture(u_LightTex, _vert_tex_light_coord);
    // Average the light color to make it grayscale
    float average_light = (light_color.r + light_color.g + light_color.b) / 3.0; 
    v_Color = _vert_color * vec4(vec3(average_light), light_color.a);
